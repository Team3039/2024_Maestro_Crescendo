...
public class RobotContainer {
  ...
  public static CommandPS4Controller joystick = new CommandPS4Controller(0); // My joystick
  ...
  private void configureBindings() {
    ...
    // reset the field-centric heading on square press
    joystick.square().onTrue(drivetrain.runOnce(() -> drivetrain.seedFieldRelative()));
