...
public class RotateToSpeakerAuto extends Command {
  /** Creates a new RotateToSpeakerAuto. */
  public RotateToSpeakerAuto() {
  ...
  public boolean isFinished() {
    return RobotContainer.vision.isAtRotationSetpoint();
  }
}
